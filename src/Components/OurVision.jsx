...
export default function OurVision() {
    ...
    useEffect(() => {
        if (loggedUserInfo?.league?.vision_banner) {
            const url = loggedUserInfo.league.vision_banner;
            setBanner(url)
        }
        if (loggedUserInfo?.league?.vision) {
            setVision(loggedUserInfo?.league?.vision)
        }
    ...
    const UpdateLeagueData = () => {
        (async () => {
            ...
            try {
                ...
                if (attachment) {
                    formData.append("vision_banner", attachment);
                }
                ...
                <div className="main-content flex flex-col flex-grow">
                    <div className="lg:p-10 bg-about text-center">
                        ...
                        {loggedUserInfo?.is_lg_admin === 1 && (
                            <span className="float-right cursor-pointer" onClick={() => setVisionModalOpen(true)}>
                    ...
                    <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        >
                            <div className="bg-white flex flex-col items-center">
                                <span
                                    onClick={() => setVisionModalOpen(!visionModalOpen)}
                                ...
                                <div className="flex flex-col justify-center items-center mt-[.5rem] mb-8">
